                ...
                <v-card flat>
                    <v-card-text>
                        <v-row>
                            ...
                            <v-col cols="12" md="4">
                                <v-text-field label="Folio" color="primary" variant="outlined"
                                    hide-details v-model="product.folio" />
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field label="Codígo de barras *" color="primary" variant="outlined"
                                    hide-details v-model="product.barcode" />
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-text-field label="Descripción" color="primary"
                                    variant="outlined" hide-details v-model="product.description" />
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-autocomplete label="Categorias *" color="primary" variant="outlined"
                                    :items="categories" item-title="name" item-value="id"
                                    hide-details v-model="product.category_id" />
                            </v-col>
                            <v-col cols="12" md="3">
                            ...
                            <v-col cols="12" md="3">
                                <v-text-field label="Precio de compra" color="primary" variant="outlined"
                                    hide-details v-model="product.price_shop" />
                            </v-col>
                            <v-col cols="12" md="3">
                            ...
                            <v-col cols="12" md="3">
                                <v-text-field label="Precio de venta" color="primary"
                                    variant="outlined" hide-details v-model="product.price" />
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-autocomplete label="Tipo *" color="primary" variant="outlined"
                                    hide-details v-model="product.type" :items="ProductTypes" item-title="text" />
                            </v-col>
                            <v-col cols="12" md="3">
                                <v-text-field label="Existencias *" color="primary" variant="outlined"
                                    hide-details v-model="product.stock" />
                            </v-col>
                            <v-col cols="12" md="3">
                                <v-text-field label="Peso (kgs) *" color="primary" variant="outlined"
                                    hide-details v-model="product.weight" />
                            </v-col>
                        </v-row>
                    </v-card-text>
                    <v-card-actions class="mx-3">
                        <v-row class="mb-3">
                            <v-col cols="12">
                                <v-btn large size="large" block class="rounded-lg bg-primary" depressed @click="createProduct">
                                    Guardar
                                </v-btn>
                            </v-col>
                        </v-row>
