<template>
    <v-card flat>
        <v-card-text>
            <v-row>
                <v-col cols="4" lg="4" class="d-flex justify-center align-center" v-if="showAvatar">
                    <v-avatar size="40" color="white" class="shadow ml-3">
                        <v-icon :color="color" size="25" block>{{ icon }}</v-icon>
                    </v-avatar>
                </v-col>
                <v-col cols="8" lg="8">
