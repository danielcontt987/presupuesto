    ...
    <v-dialog v-model="productStore.openModal" width="450" persistent>
        <v-card class="my-0 pb-2 rounded-lg">
            ...
            <v-card-actions class="mx-3">
                <v-row>
                    <v-col cols="12" md="6">
                        <v-btn :loading="productStore.loading" size="large" class="rounded-lg" large text depressed
                            block color="error" @click="closeModal()">
                            Cerrar
                        </v-btn>
                    </v-col>
                    <v-col cols="12" md="6">
                        <v-btn :loading="productStore.loading" large size="large" block class="rounded-lg bg-primary"
                            depressed @click="createCategory()">
                            Guardar
                        </v-btn>
                    </v-col>
                </v-row>
