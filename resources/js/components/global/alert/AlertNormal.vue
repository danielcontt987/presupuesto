    ...
    <v-container fluid>
        <v-dialog persistent max-width="550" v-model="alertNormal.show">
            <v-card class="rounded-lg ma-0" rounded="7">
                ...
                <v-card-title class="text-center text-black" style="font-weight: bold; word-break: break-word"
                    v-if="alertNormal.title">
                    <v-row class="mx-0">
                ...
                <v-card-actions class="mb-3">
                    <v-row class="mx-0">
                        <v-col class="text-center">
                            <v-btn size="large" flat block class="bg-primary" @click="closeModal()">
                                Entendido
                            </v-btn>
                        </v-col>
                    </v-row>
